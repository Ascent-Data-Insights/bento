...
export type TourPrepare = 'sidebar' | 'sheet' | 'close-sidebar' | 'close-sheet'
...
export interface TourStep {
  ...
  route?: string
  /** UI state actions to set up before spotlighting the target (run in order). */
  prepare?: TourPrepare[]
}
...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    placement: 'right',
    route: '/',
    prepare: ['close-sidebar', 'close-sheet'],
  },
  {
    id: 'optimize-button',
